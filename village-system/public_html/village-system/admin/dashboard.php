...
<head>
    ...
    <title>Dashboard Admin - Sistem Informasi Desa</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="operators.php">Kelola Operator</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid py-4">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-0">Dashboard Admin - Sistem Informasi Desa</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
                        ...
                        <div class="row text-center">
                            <div class="col-6">
                                <div class="stats-card success mb-0">
                                    ...
                                    <div class="stats-label">Sudah</div>
                                </div>
                            </div>
                            <div class="col-6">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Kategori Penduduk</h5>
                    </div>
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-6">
                                <div class="stats-card warning mb-0">
                                    <div class="stats-number"><?php echo $stats['total_miskin']; ?></div>
                                    <div class="stats-label">Miskin</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="stats-card danger mb-0">
                                    <div class="stats-number"><?php echo $stats['total_fakir_miskin']; ?></div>
                                    <div class="stats-label">Fakir Miskin</div>
                                </div>
                            </div>
                        </div>
